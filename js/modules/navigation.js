...
function initNavigation() {
  ...
  // Header CTA button: navigate to internship application page
  const headerCtaBtn = document.getElementById('headerCta') || document.querySelector('.learn-more');
  if (headerCtaBtn) {
    headerCtaBtn.addEventListener('click', (e) => {
      e.preventDefault();
      const internshipForm = document.getElementById('internshipForm');
      if (internshipForm) {
        internshipForm.scrollIntoView({ behavior: 'smooth' });
      } else {
